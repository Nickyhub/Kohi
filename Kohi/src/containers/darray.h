...
#define darray_reserve(typ, capacity) _darray_create(capacity, sizeof(type))
...
#define darray_insert_at(array, index, value) auto(value) temp = value; array = _darray_insert_at(array, index, &temp)
