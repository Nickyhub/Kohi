...
typedef struct renderer_backend {
	...
	b8(*end_renderpass)(struct renderer_backend* backen, u8 renderpass_id);
	...
	b8(*create_geometry)(geometry* geometry,u32 vertex_size, u32 vertex_count, const void* vertices, u32 index_size, u32 index_count, const u32* indices);
