...
#ifdef _DEBUG
	string_format(file_name, "D:/Dev/Projekte/Kohi/bin/bin/x64/Debug/assets/shaders/%s.%s.spv", name, type_str);
#elif
	string_format(file_name, "D:/Dev/Projekte/Kohi/bin/bin/x64/Release/assets/shaders/%s.%s.spv", name, type_str);)
#endif
